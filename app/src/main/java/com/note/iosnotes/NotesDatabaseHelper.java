...
public class NotesDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DELETED_NOTES_TABLE_NAME = "Delete Notes";
    public static final String DELETED_NOTES_ID = "tags_id";
    public static final String DELETED_NOTES_NAME = "tags_name";
    public static final String DELETED_NOTES_COLOR_CODE = "tags_color_code";
    public static final String DELETED_NOTES_COUNTER_NOTES = "tags_counter_note";
    ...
    public void insertNotes(Note note) {
        ...
        contentValues.put(NOTES_TIME, note.getDateModified().getTime());
        contentValues.put(NOTES_IMAGE, note.getImgByteArr());
        contentValues.put(NOTES_ISLOCK, note.isLocked());
        contentValues.put(NOTES_ISDELETE, note.isDeleted());
        contentValues.put(NOTES_ISPIN, note.isPinned());
        contentValues.put(NOTES_WIDGET, note.getWidgetId());
