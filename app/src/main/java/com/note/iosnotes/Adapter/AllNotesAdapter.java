...
public class AllNotesAdapter extends RecyclerView.Adapter<AllNotesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.TvNoteFolder.setText(folderName);
        String timeAgo = Constant.getTime(note.getDateTimeMills());
        if (note.isLockedOrNot()) {
            holder.IvNoteLock.setVisibility(View.VISIBLE);
            holder.TvNoteShortDesc.setText(timeAgo + "  " + context.getResources().getString(R.string.note_locked_string));
        } else {
            holder.IvNoteLock.setVisibility(View.GONE);
            holder.TvNoteShortDesc.setText(timeAgo + "  " + note.getNoteContent());
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        private final TextView TvNoteFolder;
        ...
        private final View ViewSeparateNotes;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            TvNoteFolder = itemView.findViewById(R.id.TvNoteFolder);
            ViewSeparateNotes = itemView.findViewById(R.id.ViewSeparateNotes);
        }
    }
